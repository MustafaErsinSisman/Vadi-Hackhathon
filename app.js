class VideoUploader {
        ...
        if (fileInput) {
            fileInput.addEventListener('change', (e) => {
                ...
                if (selectedFile) {
                    ...
                    document.getElementById('preview-player').src = URL.createObjectURL(selectedFile);
        ...
        const checkInterval = setInterval(async () => {
            try {
                ...
                if (data.status === 'processed') {
                    ...
                    this.showMessage(
                        '✅ Video işlendi! Ana sayfaya yönlendiriliyorsunuz...',
                        'success'
                    );
    ...
    async uploadSingle(file, title, description) {
        ...
        try {
            ...
            if (result.success) {
                this.showMessage('Video başarıyla yüklendi', 'success');
            } else {
                this.showMessage(result.error || 'Yükleme başarısız', 'error');
            }
        } catch (error) {
